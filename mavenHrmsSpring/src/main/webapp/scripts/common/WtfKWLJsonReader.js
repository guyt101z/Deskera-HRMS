...
Wtf.data.KwlJsonReader1 = function(meta, recordType){
     meta = meta || {};
     Wtf.data.KwlJsonReader1.superclass.constructor.call(this, meta, recordType);
      this.events = {
        aftereval : true
    };
     this.on("aftereval", this.jsonErrorResponseHandler);
 ...
 Wtf.extend(Wtf.data.KwlJsonReader1, Wtf.data.KwlDataReader, {
         read : function(response){
