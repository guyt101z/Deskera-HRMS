...
<%
        ...
        try {
           ...
           String connectionURL = "jdbc:mysql://"+serverIP+":"+port+"/"+dbName+"?user="+userName+"&password="+password;
            ...
            String companysql = " select userid from users where company = ? ";
            ...
            pstmtcompany.setString(1, "54yyffc3-f607-496b-a0a1-997c823afde1");
            ...
            while(rs.next()){
                ...
                if(rs1.next()){
                    if(rs1.getString("templateid")!=null && rs1.getString("salary")!=null){
            ...
            String wagesql = " select * from wagemaster where rate = ? and companyid = ? and computeon is null ";
            String deductionsql = " select * from deductionmaster where rate = ? and companyid = ? and computeon is null ";
            ...
            pstmtcompany.setString(2, "54yyffc3-f607-496b-a0a1-997c823afde1");
            rs1 = pstmtcompany.executeQuery();
            ...
            String payHistorysql = " select historyid,payhistory.createdon as createdon,createdfor from payhistory inner join users on users.userid = payhistory.userID where company = ? ";
            ...
            String templatesql = " select templateid from template where companyid = ? and payinterval is null and effdate is null ";
