...
*/
package com.krawler.spring.hrms.payroll.statutoryform.tp2;
...
public class TP2 {
	...
	private String bik;
	private String housingBenefitProvidedByEmployer;
	...
	public String getHolidayAllowance() {
		return holidayAllowance;
	}
	public void setHolidayAllowance(String holidayAllowance) {
	...
	public String getHousingBenefitProvidedByEmployer() {
		return housingBenefitProvidedByEmployer;
	}
	public void setHousingBenefitProvidedByEmployer(
			String housingBenefitProvidedByEmployer) {
		this.housingBenefitProvidedByEmployer = housingBenefitProvidedByEmployer;
	}
