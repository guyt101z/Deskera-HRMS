...
public class ConfigReader {
	...
	/**
	 * Sets the value of the <code>name</code> property to the name of a
	 * class. First checks that the class implements the named interface.
	 */
	...
	private void loadResource(Properties properties, Object name,
		...
		try {
			...
			if (!"krawler-conf".equals(root.getTagName()))
				System.err
						.print("bad conf file: top-level element not <krawler-conf>");
