...
public class StorageHandler {
    ...
    public static String GetDocStorePath1(){
		return ConfigReader.getinstance().get("DocStorePath1");
	}
    ...
    public static String IsStandAloneApplication() {
        return ConfigReader.getinstance().get("HRMSStandAlone");
    }
}
