...
public interface KWLErrorMsgs {
        ...
        String errProccessingData = "Error occured while processing data";
...
//        String errMsgFileFormatBAsecamp = "Error occurred while parsing file. Please uplaod proper xml file";
        ...
        String S01 = "Success";
        String F01 = "Failure";
        String hrmsGoalADD = "Goal added successfully.";
        String hrmsGoalEDIT = "Goal updated successfully.";
        String hrmsGoalFailure = "You have already assigned similar goal for the selected user. The new goal cannot be saved for the same time period.";
}
