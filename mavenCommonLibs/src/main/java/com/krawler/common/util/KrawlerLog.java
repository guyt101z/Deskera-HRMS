...
public class KrawlerLog {
	 ...
	 * info.
	 */
	public static final Log extensions = LogFactory
			.getLog("krawler.extensions");
	...
	/**
	 * Removes a <tt>MailItem</tt> id from the current thread's logging
	 * context.
	 */
	...
	public static void toolSetupLog4j(String defaultLevel, String logFile,
		...
		if (showThreads) {
			...
			p
					.put("log4j.appender.A1.layout.ConversionPattern",
							"[%x] %p: %m%n");
		}
