...
public class fieldUtil {
    ...
    public static void main(String[] args) {
      /*  fieldStructure f = new fieldStructure(0, "ss", 2, "dd", fieldStructure.ValidationType.EMAIL, fieldStructure.FieldType.TextField, "","");
        f.setField_value("sd_f.sdf@dd.com");
        List<validationError> list = ValidateField(f);
